...
{block "content"}
    ...
    <div class="row alert alert-danger" role="alert">
        ...
        <h2><span class="glyphicon glyphicon-alert" aria-hidden="true"></span> Danger Ahead <span class="glyphicon glyphicon-alert" aria-hidden="true"></span></h2>
        
        <div class="col-xs-6 col-lg-4">
            <h2>Parent Clear All</h2>
            <p></p>
            <p><a class="btn btn-default" href="#" role="button">Parent Clear All »</a></p>
        </div>
        <div class="col-xs-6 col-lg-4">
            <h2>Parent Clear</h2>
            <p></p>
            <p><a class="btn btn-default" href="#" role="button">Parent Clear »</a></p>
        </div>
    </div>
{/block}